...
struct SheetPlus<HContent: View, MContent: View>: ViewModifier {
    ...
    @State private var backgroundInteractionDetentLimit: CGFloat?
        ...
        ZStack {
            ...
            if viewWillPresent {
                ...
                VStack(spacing: 0) {
                    ...
                    VStack(spacing: 0) {
                        // Geometry reader keeps the content outside the header vertically centered
//                        GeometryReader { geometry in
                            ...
                            VStack(spacing: 0) {
                                ...
                                .frame(height: showDragIndicator == .hidden ? 0 : 22)
                                .opacity(showDragIndicator == .hidden ? 0 : 1)
...
//                        Spacer()
                    ...
                    .onChange(of: translation) { value in
                        ...
                        if let interactionDetent = backgroundInteractionDetentLimit {
                            isBackgroundInteractionEnabled = translation < interactionDetent
                        }
                    }
        ...
        .onPreferenceChange(SheetPlusBackgroundInteractionKey.self) { value in
            backgroundInteractionDetentLimit = value
        }
